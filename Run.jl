...
@everywhere include("src/polar.jl")
@everywhere include("src/diffraction_para.jl")
include("src/initboules.jl")
...
if(Parallel)
	...
	@everywhere include("src/polar.jl")
	@everywhere include("src/diffraction_para.jl") #On réecrit les @everywhere avant d'appeler la fonction Image_Multi_Proc ... 
